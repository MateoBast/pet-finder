...
importers:
  ...
  .:
    dependencies:
      ...
      mailtrap:
        specifier: ^4.10.0
        version: 4.10.0(nodemailer@9.0.5)
      multer:
        specifier: ^2.2.0
        version: 2.2.0
      nodemailer:
...
packages:
  ...
  mailgun.js@14.0.0:
    resolution: {integrity: sha512-3JOytYg/Ff8Itrw74gfwQjylcu/tBEMf4O2HdpfgMqCLON6kypreVDYy5nUqrvMYjtDPVsCV1yKU8mvWsg4VPw==}
    engines: {node: '>=18.0.0'}

  mailtrap@4.10.0:
    resolution: {integrity: sha512-WgLKOmgy8HhvjXMb4S+E2NVjgJLbDUC17lMFKsKNwBxTBteD2sin2m2wuEVbdppluq5YL5A1saNhSW8FvUdm/g==}
...
snapshots:
  ...
  mailtrap@4.10.0(nodemailer@9.0.5):
    dependencies:
      axios: 1.19.0
      qs: 6.15.3
